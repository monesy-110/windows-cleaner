...
下面的截图展示了空间清理页：清理项目按风险和可释放空间分组，右侧计划栏会同步显示选中项目、潜在影响与保护规则。

<p align="center">
  <img src="assets/readme-screenshot.png" alt="磁盘管家空间清理界面预览" width="1440" />
</p>
...
│  └─ readme-screenshot.png   README 界面预览
├─ public/
